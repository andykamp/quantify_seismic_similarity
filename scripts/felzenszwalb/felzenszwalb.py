...
# felzenszwalb clustering from https://towardsdatascience.com/image-segmentation-using-pythons-scikit-image-module-533a61ecc980
...
print("number regions: ", np.unique(image_felzenszwalb).size)
plt.imshow(color.label2rgb(image_felzenszwalb, img, kind='avg'));
#plt.show()
plt.savefig('2.felzenszwalb.jpg')
